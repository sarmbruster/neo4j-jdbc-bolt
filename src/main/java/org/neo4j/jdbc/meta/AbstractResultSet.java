...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    public AbstractResultSet( List<Neo4jColumnMetaData> columns )
    {
    ...
    /*public AbstractResultSet( List<String> columns )
    {
        this.cols = columns.size();
...
//            {
                System.out.println("Couldn't convert value " + value + " of type " + type + " to JSON " + e.getMessage() );
//            }
        }
        return value.toString();
